...
<html lang="zxx">
    ...
    <body>
                                            ...
                                            <ul class="nav navbar-nav">
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a href="service-2.html">service 2</a></li><li><a href="service-detail.html">service detail</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="page-head">
                                <div class="page-header-heading">
                                    <h3 class="theme-color">Book table</h3>
                                </div>
        ...
        <section class="padT100 padB70">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 pull-left">
                        <div class="theme-form marB30">
                            <h3 class="marB30">Your comment</h3>
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 marB30 positionR">
                                    ...
                                    <i class="fa fa-calendar-o input" aria-hidden="true"></i>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 marB30 positionR">
                                    <input type="text" placeholder="Time">
                                    <i class="fa fa-clock-o input" aria-hidden="true"></i>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 marB30 positionR">
                                    <input type="text" placeholder="Seats" >
                                    <i class="fa fa-th input" aria-hidden="true"></i>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12 marB20 positionR">
                                    <textarea placeholder="Type your question" rows="6"></textarea>
            ...
            <div class="theme-form-background">
                <figure class="bottom-left">
                    <img src="assets/img/background/theme-form-back.png" alt=""/>
                </figure>
                <figure class="bottom-right">
                    <img src="assets/img/background/theme-form-back-2.png" alt=""/>
                </figure>
            </div>
        </section>
        <!--//================Book Table end==============//-->
